...
function Content() {
  return (
    <div>
      <div className="lg:pt-16 bg-gray-100 lora duration-300 ease-in transition-all">
        <div className=" lg:m-0 mx-auto">
          <div className="grid grid-cols-2">
            <div className="lg:col-span-1 col-span-2">
              <img src="https://img.freepik.com/premium-photo/group-people-standing-together-facing-large-crowd-suitable-use-as-background-concept-image_153912-326820.jpg?w=740" alt="" className="w-full h-full object-cover" />
            </div>

            <div className="lg:col-span-1 col-span-2 lg:px-10 lg:py-5 md:px-10 md:py-16 px-4 py-8">
              <h4 className="md:text-4xl text-3xl lora font-bold">
                About the Ministry
              </h4>

              <p className="pt-4 pb-3 md:text-lg text-base lora">
                God of all nations is world evangelical ministries
              ...
              <p className="pt-4 pb-3 md:text-lg text-base lora">
                To organize and conduct doctrinal crusades, seminars, revivals, Holy convocations and spiritual guidance meetings. Such as Bible based events are especially crucial to the empowerment of our current stock of leaders. To groom candidates who demonstrate the proper spirit, zeal, and metal attitude to assume future leadership responsibilities.
              </p>
