...
function Error() {
  return (
    <div>
      <div className="min-w-screen min-h-screen bg-black flex items-center lg:px-20 md:px-10 px-4 overflow-hidden relative">
        <div
          className="flex-1 min-h-full min-w-full rounded-3xl bg-white/20 shadow-xl p-10 lg:p-20 text-gray-800 relative md:flex items-center text-center md:text-left">
          <div className="w-full md:w-1/2">
            <div className="mb-10 lg:mb-20">
              <div className="flex items-center">
                <img src="/vite.svg" alt="logo" />
                <p className="text-2xl font-bold maincol">Adullam</p>
              </div>
            </div>
            <div className="mb-6 md:mb-20 text-white font-semibold">
              <h1 className="font-black uppercase text-2xl md:text-3xl lg:text-5xl text-orange-700 md:mb-10 mb-3">You seem to be lost!</h1>
              <p>The page you&apos;re looking for isn&apos;t available.</p>
              <p>Try searching again or use the Go Back button below.</p>
            </div>
            <div className="mb-20 md:mb-0">
              <button className="text-lg font-bold outline-none focus:outline-none transform transition-all hover:scale-110 text-white hover:text-gray-100">
                <Link to='/' classNameName="bg-blue-400 text-white px-4 py-2 rounded">Return to Home Page</Link>
              </button>
            </div>
          </div>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 441.85 285.44"
              ...
              <g id="OBJECTS">
                ...
                <g>
                  ...
                  <ellipse transform="rotate(-9.249 191.082 198.565)" className="st6" cx="191.05" cy="198.49"
                    rx="9.23" ry="9.23" />
                  <path className="st4"
                  ...
                  <ellipse transform="rotate(-9.249 292.07 198.575)" className="st6" cx="292.01" cy="198.49" rx="9.23"
                    ry="9.23" />
                  <path className="st4"
        ...
        <div
          className="w-96 h-full bg-yellow-200 bg-opacity-20 absolute -bottom-96 right-64 rounded-full pointer-events-none -rotate-45 transform">
        </div>
      </div>
