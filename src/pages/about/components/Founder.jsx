...
function Founder() {
  return (
    <div>
      <div className="lg:py-16 pb-16 duration-300 ease-in transition-all dark:bg-gray-950 dark:text-white">
        <div className="w-[90%] md:w-[85%] mx-auto">
          <div className="grid grid-cols-2 gap-10">
            <div className="lg:col-span-1 col-span-2">
              <h1 className="md:text-4xl text-3xl md:pb-2 boss">
                BISHOP GODBLESS ABU
              </h1>

              <p className="lora md:text-lg text-base py-6">
              ...
              <p className="lora md:text-lg text-base pb-6">
